...
D.Home:AddParagraph({
    Title = "jinggel n word",
    Content = "did u know fufu own zypherion, did u know i m so sigma"
})
D.Home:AddButton({
    Title = "our community";
    Description = "Click this button to copy the community link.",
    Callback = function()
        setclipboard("https://watchpeopledie.tv")
        Z:Notify({
            Title = "cihuyy";

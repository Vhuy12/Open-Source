...
local v = (loadstring(game:HttpGet("https://raw.githubusercontent.com/Jxereas/UI-Libraries/main/notification_gui_library.lua", true)))()
local E = w:CreateWindow({
    Title = "idkwhatisthis script";
    Icon = "banana",
    Author = "Discord: v0_x0";
    Folder = "YOU_GOT_RATTTED";
    ...
    User = {
        ...
        Callback = function()
            ...
            local v, E = nil, w:GetCurrentTheme()
            if table.find(themes, E) == # themes then
                v = - 5
            else
                v = 1
            end
            w:SetTheme((themes)[table.find(themes, E) + v])
        end
    }
})

...
local Window = Fluent:CreateWindow({Title = "jinggel nigger",SubTitle = "| https://discord.gg/nodex",TabWidth = 155,Size = UDim2.fromOffset(555, 320),Acrylic = false,Theme = "Amethyst",MinimizeKey = Enum.KeyCode.End})
local Tabs = {
...
ImageButton.Image = "rbxassetid://92990576771880"
...
if IsPc then
  if not string.find(executor, "Wave") or not string.find(executor, "AWP") then
    Fluent:Notify({Title = "Free Script",Content = "your executor isn't offically supported, you may experience bug or glitch",SubContent = "Jaia",Duration = 15})
  else
    Fluent:Notify({Title = "Free Script",Content = "Nice",SubContent = "Jaia",Duration = 15})
  end
else
  Fluent:Notify({Title = "Free Script",Content = "Nice",SubContent = "Jaia",Duration = 15})
end
